...
sess = tf.Session()
# Train
trn_img_a_list  = glob.glob('./datasets/' + dataset + '/trainA/*.jpg')
trn_img_b_list  = glob.glob('./datasets/' + dataset + '/trainB/*.jpg')
...
# Test
tst_img_a_list  = glob.glob('./datasets/' + dataset + '/trainA/*.jpg')
tst_img_b_list  = glob.glob('./datasets/' + dataset + '/trainB/*.jpg')
